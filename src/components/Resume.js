...
const Resume = () => {
    const config = {
        ...
        <div className="py-5 px-100 md:w-1/2 flex justify-center ">
            <img src={ResumeImg} className="w-[380px] h-[290px] img-round-border" />
        </div>
        <div className="flex md:w-1/2 px-6 justify-center ">
            <div className="flex flex-col justify-center">
               ...
               <div className="text-white">
                    <p className=" pb-5">Feel free to take a look at my resume. <a href={config.link} className="btnn img-round-border">Download</a></p>
